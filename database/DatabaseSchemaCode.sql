...
-- -----------------------------------------------------
DROP DATABASE IF EXISTS Ireland;
CREATE DATABASE  `Ireland` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_cs ;
USE `Ireland` ;
...
CREATE TABLE IF NOT EXISTS `ClassicModels`.`Customers` (
  ...
  `customerLocation` POINT NOT NULL SRID 4326,
